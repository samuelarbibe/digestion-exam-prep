...
export const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      "אפיתל מעבר (transitional) – כמו בשלפוחית השתן",
      "אפיתל שטוח רב-שכבתי (stratified squamous) – לא קרטיניזציה מלאה",
      "אפיתל גלנדולרי (glandular) – עם בלוטות הפרשה",
      "אפיתל עמודי חד-שכבתי (simple columnar) – כמו בקיבה",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "ליבת muscularis mucosae עם ganglia של Auerbach",
      "ליבת lamina propria עם כלי דם ו-lacteal, מכוסה אפיתל עמודי עם goblet cells",
      "ליבת connective tissue של serosa עם mesothelium",
      "ליבת submucosa עם plexus submucosus וכלי דם גדולים",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "בבסיס gastric pits של הקיבה",
      "באפיתל השטוח של הוושט הפרוקסימלי",
      "ב-sinusoids של hepatic lobule בכבד",
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "הפרשת mucus מ-goblet cells",
      "פריסטלטיקה עיקרית של כל דופן המעי",
      "ספיגת חומצות שומן ב-ileum",
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      "אנטיביוטיקה רחבה ל-eradication",
      "PPI לטווח ארוך כטיפול יחיד",
      "הרחבה פנאומטית אנדוסקופית או ניתוח הלר (cardiomyotomy)",
      "כימותרפיה לפני כל טיפול אנדוסקופי",
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "achalasia – אי-מנוחה של LES",
      "stenosis פיברוטית מ-GERD כרוני",
      "גידולים שפירים (papilloma) של הרירית הוושטית",
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "H. pylori גורם רק ל-CRC ללא קשר לפצעת",
      "H. pylori מונע פצעות על ידי הגברת mucus",
      "H. pylori מדכא gastrin ומונע hyperacidity",
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "PPI בלבד למשך 4 שבועות ללא אנטיביוטיקה",
      "bismuth בלבד ללא PPI או אנטיביוטיקה נוספת",
      "אנטיביוטיקה בודדת (amoxicillin) למשך 7 ימים",
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      "מצב אסימפטומטי תמיד עד perforation",
      "כאב שמוקל באכילה – כמו ב-duodenal ulcer",
      "כאב epigastric שמחמיר באכילה (pain worsened by food)",
      "כאב לילי בלבד ללא קשר לאכילה",
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "דלקת אנטרלית מ-H. pylori בלבד",
      "גסטריטיס ללא השפעה על ספיגת B12",
      "אוטואימונית נגד parietal cells → חוסר B12 ו-pernicious anemia",
      "דלקת חריפה erosive מ-NSAIDs",
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "colonoscopy בלבד ללא biopsy קיבתי",
      "urea breath test, stool antigen, biopsy עם histology/rapid urease",
      "בדיקת B12 בדם – לאבחון pernicious anemia",
      "ERCP – לבדיקת ampulla of Vater",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "פצעת peptic פשוטה עם דימום",
      "adenocarcinoma – סרטן שכיח של הקיבה",
      "lymphoma לימפואידי קשור ל-H. pylori, עשוי להגיב ל-eradication",
      "adenocarcinoma – סרטן אפיתלiali שכיח בקיבה",
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "ספיגת שומן ישירה ב-duodenum",
      "גירוי ghrelin ותיאבון",
      "גירוי הפרשת HCl מ-parietal cells",
  ...
  },
  {
    ...
    options: [
      ...
      "גירוי הפרשת HCl מ-parietal cells",
      "גירוי אינסולין מתאי β בלבלב",
      "פריסטלטיקה וושטית בזמן בליעה",
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "peristalsis במעי הגס – mass movement",
      "ספיגת חומרי מזון ב-jejunum",
      "הפרשת bile מ-hepatocytes ל-duodenum",
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      "אחסון glycogen בלבד, ללא תפקיד ב-bilirubin או בחלבוני דם",
  ...
  },
  {
    ...
    options: [
      "Crohn – crypt abscesses רציפים; UC – granulomas לא caseating בלבד",
      "זהים היסטולוגית לחלוטין ונבדלים רק בסרולוגיה (ASCA/p-ANCA)",
      "UC – transmural עם granulomas; Crohn – רק רירית ללא fistulas",
  ...
  },
  {
    ...
    options: [
      "PPI בלבד ל-induction ו-maintenance ללא immunomodulators",
      "corticosteroids, immunomodulators (azathioprine) ו-biologics (infliximab)",
      "antibiotics ל-H. pylori בלבד ללא biologics או steroids",
      "pneumatic dilation של LES כטיפול ל-strictures ו-fistulas",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Barrett esophagus כביטוי יחיד של IBD ללא מעורבות מפרקים או עור",
      "heartburn ו-regurgitation כתסמינים יחידים ללא מעורבות עור או מפרקים",
      "acute cholecystitis עם RLQ point tenderness בלבד",
  ...
  },
  {
    ...
    options: [
      "UC חמור עם toxic megacolon, dilation >6 ס\"מ ו-systemic toxicity",
      "שלשול כרוני עם histology אבנורמלית (lymphocytic/collagenous) ו-colonoscopy תקינה מקרוסקופית",
      "Crohn עם fistula enterovesical ו-transmural inflammation",
      "GERD עם erosive esophagitis ו-pH monitoring חיובי",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "UC עם pancolitis ו-pseudopolyps ללא APC mutation",
      "polyp אדנומטי בודד sporadic ללא גנטיקה או סיכון משפחתי",
      "Lynch syndrome עם MMR deficiency ו-polyp count נמוך יחסית",
  ...
  },
  {
    ...
    options: [
      ...
      "colonoscopy עם bowel prep – הדמיה של colon ללא cannulation",
      "EGD סטנדרטי ללא injection contrast ל-bile או pancreatic ducts",
      "barium swallow – fluoroscopy של esophagus ללא endoscope",
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      "רק עורק מרכזי ללא נימי דם או לימפה",
      "plexus myenteric (Auerbach) ו-ganglia אנטריים",
      "lacteal (צינור לימפה מרכזי) ורשת capillaries לספיגת חומרים ממוססים",
      "בלוטת Brunner ורקמת conjunctive submucosal",
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "fistulas perianal, strictures ו-abscesses טרנסמורליים",
      "toxic megacolon, fulminant colitis ו-CRC מיידי",
      "דימום (hematemesis/melena), perforation, gastric outlet obstruction",
      "צהבת cholestatic, ascites ו-hepatic encephalopathy",
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "ספיגת מים ואלקטרוליטים עיקרית ב-stomach",
      "ספיגת B12 ישירות ב-antrum ללא intrinsic factor",
      "ניטרול salivary amylase, הפעלת pepsinogen→pepsin, חיסול patogenים",
      "הפרשת bile מ-hepatocytes וכיווץ gallbladder",
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Brunner glands, Paneth cells ו-hepatic acini",
      "parotid בלבד – כל שאר הרוק מגיע מ-gastric glands",
      "parotid (תת-אוזנית), submandibular (תת-לסתית), sublingual (תת-לשונית)",
      "hepatic, pancreatic ו-gastric exocrine glands",
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "בלוטות הפרשה של digestive enzymes ל-lumen",
      "חיבור המעי לדופן הבטן, מעבר כלי דם/לימפה/עצבים, תמיכה מבנית",
      "שכבת אפיתל עם microvilli לספיגת נוטריינטים",
      "יצירת bile salts ו-enterohepatic circulation",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "פתיחת LES במנוחה לאפשר gastric emptying",
      "שליטה ביציאת צואה מ-rectum במהלך defecation",
      "הפרשת gastrin מ-G cells באנטרום",
  ...
  },
  {
    ...
    question: "מהם סימני portal hypertension?",
    options: [
      "steatorrhea, diabetes ו-calcifications לבלב בלבד",
      "bloody diarrhea, pseudopolyps ו-crypt abscesses",
      "heartburn, regurgitation ו-dysphagia כסימנים מובילים",
  ...
  },
  {
    ...
    options: [
      "toxic megacolon, fulminant UC ו-pouchitis",
      "achalasia, bird-beak sign ו-failed LES relaxation",
      "jaundice, coagulopathy, hypoalbuminemia/ascites, SBP, hepatic encephalopathy, gynecomastia",
      "peptic ulcer bleeding, perforation ו-gastric outlet obstruction",
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "צהבת ו-Charcot triad כקריטריונים היחידים",
      "2 מתוך 3: כאב תואם, lipase/amylase ≥3× ULN, imaging תומך",
      "biopsy לבלב חובה לאבחנה בכל מקרה",
      "חום בלבד או leukocytosis כקריטריון יחיד",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "צום מוחלט ממושך (שבועות) ככלל ראשון",
      "ניתוח מיידי בכל מקרה ללא ניסיון טיפול שמרני",
      "נוזלים IV, ניטור, משככי כאב, תזונה מוקדמת – ללא אנטיביוטיקה שגרתית",
      "אנטיביוטיקה פרופילקטית לכל המטופלים",
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "מוגבלת ל-colon בלבד ללא מעורבות מערכתית",
      "זיהומית, חדה וניתנת לריפוי מלא ללא התלקחויות",
      "גנטית בלבד ללא מעורבות חיסונית",
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      "עישון מגן מ-Crohn ומגביר סיכון ל-UC",
      "עישון מעלה סיכון ל-Crohn; עשוי להגן ב-UC (החמרה אפשרית בהפסקה)",
      "עישון מגן מ-Crohn ו-UC באותה מידה",
      "אין קשר בין עישון ל-IBD בכלל",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "שניהם: רק superficial erosion ללא crypt changes",
      "זהים לחלוטין – אין הבדל היסטולוגי",
      "UC: transmural + non-caseating granulomas; Crohn: mucosal בלבד + crypt abscesses",
      "UC: mucosa/submucosa, רציף, crypt abscesses; Crohn: transmural, skip lesions, non-caseating granulomas",
    ],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      "רק גיל מעל 70 עם CRC בודד",
      "רק CRC ללא סרטנים אקסטרא-קוליים",
      "polyp אחד ב-colonoscopy כקריטריון יחיד",
  ...
  },
  {
    ...
    options: [
      "hepatic encephalopathy ו-asterixis",
      "perforation, דימום post-polypectomy, כוויה, הפרעות אלקטרוליטים מה-prep",
      "post-ERCP pancreatitis בכל colonoscopy",
      "אין סיבוכים משמעותיים – פרוצדורה ללא סיכון",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "רק ייצור bile – ללא מטבוליזם, detoxification או סינתזת חלבונים",
      "רק הפרשת insulin – תפקיד endocrine בלעדי ללא תפקידי parenchyma",
      "רק ספיגת נוטריינטים – כמו enterocytes במעי דק עם villi ו-microvilli",
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      "הפטיטיס ויראלית כרונית מ-HBV",
      "מחלת הצטברות נחושת אוטוזומלית רצסיבית – cirrhosis, neuro, סימנים נוירולוגיים rings",
      "חוסר נחושת תזונתי – anemia ו-neuropathy",
      "הצטברות ברזל תורשתית (hemochromatosis) → cirrhosis",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "מעקב בלבד ללא טיפול – GERD נפתרת תמיד ללא התערבות",
      "אנטיביוטיקה ל-H. pylori ללא בדיקה או אבחנה מוקדמת",
      "EGD דחופה בכל מקרה של pyrosis ללא קשר לגיל או תסמינים",
      "PPI יומי + שינויי אורח חיים; EGD אם אין שיפור או alarm symptoms",
    ],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      "observation בלבד – כאב RUQ אחרי ארוחה שמנה תמיד עובר",
      "EGD – cholecystitis מאובחנת תמיד באנדוסקופיה",
      "MRCP בלבד ללא אולטרסאונד – הבדיקה הראשונה ב-RUQ pain",
  ...
  },
  {
    ...
    options: [
      ...
      "pancreatic cancer – כימותרפיה מיידית ללא drainage",
      "acute hepatitis A – מנוחה ותזונה בלבד",
      "GERD – PPI ושחרור",
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      "hemochromatosis – אבחנה ראשונה ב-US steatosis",
      "acute viral hepatitis – תמיד עם ALT <100",
      "NAFLD/NASH – שומן בכבד קשור למטבוליזם; fibrosis assessment",
      "alcoholic hepatitis – תמיד עם ALT נורמלי",
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "ברזל PO בלבד – אין צורך בחיפוש מקור דימום",
      "colonoscopy – iron deficiency anemia בגיל >50 דורשת שלילת CRC/malignancy",
      "B12 injection – MCV נמוך מצביע תמיד על B12",
      "אולטרסאונד כבד בלבד – מספיק ב-anemia",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "סקר ממוצע מגיל 50 בלבד – משפחתיות לא משנה",
      "אין צורך בסקר אם אסימפטומטי",
      "colonoscopy מגיל 40 או 10 שנים לפני המקרה המוקדם ביותר במשפחה",
      "FIT שנתי בלבד – מספיק ב-high-risk family history",
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "antibiotics PO בלבד ללא IV steroids או הערכה בימים 3–5",
      "IV corticosteroids (hydrocortisone/methylprednisolone) – ASUC protocol",
      "PPI ו-5-ASA PO בלבד בשחרור מיידי ללא סטרואידים IV",
      "appendectomy דחופה – UC חריף מטופל תמיד בניתוח ראשון",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "colonoscopy ראשונה – pancreatic cancer מאובחן שם",
      "abdominal CT (pancreatic protocol) – חשד ל-pancreatic head cancer",
      "EGD בלבד – צהבת תמיד מ-PUD",
      "observation – painless jaundice שכיח ושפוט",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "GERD erosive – heartburn בלבד; glossitis ו-anemia לא קשורים",
      "acute viral hepatitis – macrocytic anemia ו-esophageal web נדירים",
      "achalasia – dysphagia לנוזלים ומוצקים; MCV בדרך כלל נורמלי",
    ],
    correctIndex: 0,
    explanation:
